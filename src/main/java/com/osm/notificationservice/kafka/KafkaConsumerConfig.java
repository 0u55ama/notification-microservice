...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Map<String, String>> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);  // Use JsonDeserializer
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Map.class);  // Map.class for deserialization
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Map<String, String>> kafkaListenerContainerFactory() {
        ...
        // Optional: Configure error handler for retries or dead letter publishing
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(new FixedBackOff(5000L, 3));  // Retry 3 times with 5 seconds delay
